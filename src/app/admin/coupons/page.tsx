export default function CouponsPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white rounded-[8px] border border-gray-100 shadow-sm p-8 text-center space-y-4">
      ...
      <h1 className="text-2xl font-bold font-serif text-charcoal">Coupons & Discounts</h1>
      <p className="text-muted max-w-md">
        This module is currently under development. Soon, you'll be able to create discount codes and promotional campaigns.
      </p>
    </div>
  );
}
